...
public class NotificationHelper extends ContextWrapper {
    ...
    public void createChannels(){
        ...
        channel_1.setLightColor(R.color.design_default_color_primary);
    ...
    public NotificationCompat.Builder getChannel_1Notification(){
        return new NotificationCompat.Builder(getApplicationContext(), channel1id).setSmallIcon(R.drawable.ic_android);
    }
